...
**Step 1**: Contract owner calls `initial-liquidity(1000 WELSH, 119000 STREET)`
...
| Aspect | `provide-liquidity` | `initial-liquidity` |
|--------|---------------------|---------------------------|
...
1. **Initial Setup**: Contract owner calls `initial-liquidity` based on current WELSH market price, establishing fair pool ratio
