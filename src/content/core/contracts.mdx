...
- Distributes 3B STREET across 21,000 NFTs (100k standard, 1M milestone)
...
- Implements token swaps with 1% immutable fee (all fees distributed to liquidity providers)
- **Contract Links:** [Mainnet](/)
- **Contract Links:** [Testnet](/)
...
- 1,000,000 STREET milestone (position 21 in each cycle)
