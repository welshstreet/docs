...
# Fee Structure & Protocol Operations
...
#### Fee Component (Liquidity Provider Distributions)
- **Purpose**: Provides token distributions to LP token holders
- **Distribution**: Automatically distributed through the distribution contract's zero-debt system
- **Range**: 0.50% - 2.00% (50 - 200 basis points)
- **Default**: 1.00% (100 basis points)
- **Token Flow**: Input tokens → Distribution contract → Distributed proportionally to LP holders

#### Revenue Component (Protocol Operations)
- **Purpose**: Funds protocol development and operations
- **Distribution**: Sent directly to the configurable treasury address
- **Range**: 0.50% - 2.00% (50 - 200 basis points)
- **Default**: 1.00% (100 basis points)
- **Token Flow**: Input tokens → Treasury address → Protocol operations
...
Fee (LP distributions): 1,000,000 * 100 / 10000 = 10,000 WELSH
...
Input: 1,000,000 WELSH tokens
Fee (LP distributions): 1,000,000 * 200 / 10000 = 20,000 WELSH
...
### 2. Revenue - Protocol Operations Fund

**Purpose**: Protocol fees for operations including development, infrastructure, and maintenance.
