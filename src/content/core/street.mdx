...
**STREET's** emission schedule draw inspiration from the King of Crypto: Bitcoin and the (soon to be de-throned) King of Memes: **DOGE**.

### DOGE-inspired Emission

STREET pays homage to Bitcoin and DOGE through its hybrid emission mechanics - **10,000 tokens minted every Bitcoin block**. Because well, Welsh is a corgi after all. The 10,000 figure comes from DOGE. The DOGE contract rewards DOGE miners 10,000 DOGE every block with a block arriving approximately every minute.
