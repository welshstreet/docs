...
### 1. Genesis Contract (`genesis.tests.clar`)
...
### 2. Credit Contract (`credit.tests.clar`)
...
### 3. Street Contract (`street.tests.clar`)
...
### 4. Exchange Contract (`exchange.tests.clar`)
...
### 5. Rewards Contract (`rewards.tests.clar`)
