...
To house the Meme Rewards tokenomics, a dedicated exchange need to be built. At its core, the Welsh Street Exchange is a Uniswap V2-style Automated Market Maker (AMM) enhanced with a native rewards layer: The Meme Rewards Protocol.
