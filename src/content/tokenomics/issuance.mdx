...
<Callout type="info" emoji="🚀">Fixed emissions are best for meme rewards because rewards are perpetual without compounding supply growth and the inflation rate declines over time.</Callout>